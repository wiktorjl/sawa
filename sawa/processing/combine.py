...
Usage:
    python -m sawa.processing.combine
    python -m sawa.processing.combine --input-dir data/fundamentals
"""
...
""",
    ...
    for fund_type in sorted(types):
        ...
        try:
            rows = combine_fundamentals(args.input_dir, args.output_dir, fund_type, logger)
