...
This module provides functions to convert sawa.domain models
to sawa_tui.models.queries dataclasses, maintaining backward
...
from sawa_tui.models import queries as tui
