...
Usage:
    ...
    # For testing
    from sp500_tools.repositories import set_factory, reset_factory
...
class RepositoryFactory:
    ...
    def get_price_repository(
        ...
        if cache_key not in self._instances:
            if provider == "database":
                ...
                from sp500_tools.repositories.polygon_prices import (
    ...
    def get_fundamental_repository(
        ...
        if cache_key not in self._instances:
            if provider == "database":
                from sp500_tools.repositories.database import (
