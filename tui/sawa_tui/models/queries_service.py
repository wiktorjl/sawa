...
Usage:
    from sawa_tui.models.queries_service import StockQueriesViaService

    # Use service-based queries
    company = StockQueriesViaService.get_company("AAPL")

    # Or use the factory function
    from sawa_tui.models.queries_service import get_queries
...
# sawa_tui.services imports from queries which imports from queries_service
